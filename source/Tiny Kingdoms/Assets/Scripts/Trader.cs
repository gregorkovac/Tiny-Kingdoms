...
public class Trader : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (this.TryGetComponent(typeof(KingdomController), out Component component)) {
            this.GetComponent<KingdomController>().menu.SetActive(true);
        } else
        {
            GameObject.Find(this.name + "/Menu").gameObject.SetActive(true);
        }
     ...
     //   this.GetComponent<Trader>().tradeMenu.SetActive(true);
        ...
        if (this.TryGetComponent(typeof(KingdomController), out component))
        {
    ...
    public void ResetTrade()
    {
        ...
        if (this.TryGetComponent(typeof(KingdomController), out Component component))
        {
            if (this.GetComponent<KingdomController>().wheat >= 20)
            {
                ...
                valueWheat = (10 - NPCWheat) * (this.GetComponent<NPCKingdomController>().relationship / 10);
                NPCLevel += NPCWheat;
            }
            else
            {
                //   valueWheat = (20 - this.GetComponent<KingdomController>().wheat) * (this.GetComponent<NPCKingdomController>().relationship / 10);
                valueWheat = (20 - NPCWheat) * (this.GetComponent<NPCKingdomController>().relationship / 10);
            }
            ...
            if (this.GetComponent<KingdomController>().wood >= 20)
            {
                ...
                valueWood = (10 - NPCWood) * (this.GetComponent<NPCKingdomController>().relationship / 10);
                NPCLevel += NPCWood;
            }
            else
            {
                //   valueWood = (20 - this.GetComponent<KingdomController>().wood) * (this.GetComponent<NPCKingdomController>().relationship / 10);
                valueWood = (20 - NPCWood) * (this.GetComponent<NPCKingdomController>().relationship / 10);
            }
            ...
            if (this.GetComponent<KingdomController>().stone >= 20)
            {
                ...
                valueStone = (10 - NPCStone) * (this.GetComponent<NPCKingdomController>().relationship / 10);
                NPCLevel += NPCStone;
            }
            else
            {
                //  valueStone = (20 - this.GetComponent<KingdomController>().stone) * (this.GetComponent<NPCKingdomController>().relationship / 10);
                valueStone = (20 - NPCStone) * (this.GetComponent<NPCKingdomController>().relationship / 10);
            }
            ...
            if (this.GetComponent<KingdomController>().coal >= 20)
            {
                ...
                valueCoal = (10 - NPCCoal) * (this.GetComponent<NPCKingdomController>().relationship / 10);
                NPCLevel += NPCCoal;
            }
            else
            {
              //  valueCoal = (20 - this.GetComponent<KingdomController>().coal) * (this.GetComponent<NPCKingdomController>().relationship / 10);
                valueCoal = (20 - NPCCoal) * (this.GetComponent<NPCKingdomController>().relationship / 10);
            }
            ...
            if (this.GetComponent<KingdomController>().iron >= 20)
            {
                ...
                valueIron = (10 - NPCIron) * (this.GetComponent<NPCKingdomController>().relationship / 10);
                NPCLevel += NPCIron;
            }
            else
            {
                //  valueIron = (20 - this.GetComponent<KingdomController>().iron) * (this.GetComponent<NPCKingdomController>().relationship / 10);
                valueIron = (20 - NPCIron) * (this.GetComponent<NPCKingdomController>().relationship / 10);
            }
            ...
            if (this.GetComponent<KingdomController>().gold >= 20)
            {
                ...
                valueGold = (10 - NPCGold) * (this.GetComponent<NPCKingdomController>().relationship / 10);
                NPCLevel += NPCGold;
            }
            else
            {
                //valueGold = 2 * (20 - this.GetComponent<KingdomController>().gold) * (this.GetComponent<NPCKingdomController>().relationship / 10);
                valueGold = (20 - NPCGold) * (this.GetComponent<NPCKingdomController>().relationship / 10);
            }

            valueWheat = valueWheat / 5;
            valueWood = valueWood / 5;
            valueStone = valueStone / 5;
            valueCoal = valueCoal / 5;
            valueIron = valueIron / 5;
            valueGold = valueGold / 5;

            if (valueWheat < 0) valueWheat = 0;
            if (valueWood < 0) valueWood = 0;
            if (valueStone < 0) valueStone = 0;
            if (valueCoal < 0) valueCoal = 0;
            if (valueIron < 0) valueIron = 0;
            if (valueGold < 0) valueGold = 0;
        } else
        {
            NPCWheat = (int)Mathf.Floor(Random.Range(0, 10));
            valueWheat = (int)Mathf.Floor(Random.Range(0, 10-NPCWheat));
            NPCLevel += NPCWheat;

            NPCWood = (int)Mathf.Floor(Random.Range(0, 10));
            valueWood = (int)Mathf.Floor(Random.Range(0, 10 - NPCWood));
            NPCLevel += NPCWood;

            NPCCoal = (int)Mathf.Floor(Random.Range(0, 10));
            valueCoal = (int)Mathf.Floor(Random.Range(0, 10 - NPCCoal));
            NPCLevel += NPCCoal;

            NPCStone = (int)Mathf.Floor(Random.Range(0, 10));
            valueStone = (int)Mathf.Floor(Random.Range(0, 10 - NPCStone));
            NPCLevel += NPCStone;

            NPCIron = (int)Mathf.Floor(Random.Range(0, 1));
            valueIron = (int)Mathf.Floor(Random.Range(0, 10 - NPCIron));
            NPCLevel += NPCIron;

            NPCGold = (int)Mathf.Floor(Random.Range(0, 5));
            valueGold = (int)Mathf.Floor(Random.Range(5, 15));
            NPCLevel += NPCGold;
        ...
        if (valueWheat < 1)
        {
            addWheat.GetComponent<Button>().interactable = false;
            removeWheat.GetComponent<Button>().interactable = false;
        } else
        {
            addWheat.GetComponent<Button>().interactable = true;
            removeWheat.GetComponent<Button>().interactable = true;
        }

        if (valueWood < 1)
        {
            addWood.GetComponent<Button>().interactable = false;
            removeWood.GetComponent<Button>().interactable = false;
        }
        else
        {
            addWood.GetComponent<Button>().interactable = true;
            removeWood.GetComponent<Button>().interactable = true;
        }

        if (valueStone < 1)
        {
            addStone.GetComponent<Button>().interactable = false;
            removeStone.GetComponent<Button>().interactable = false;
        }
        else
        {
            addStone.GetComponent<Button>().interactable = true;
            removeStone.GetComponent<Button>().interactable = true;
        }

        if (valueCoal < 1)
        {
            addCoal.GetComponent<Button>().interactable = false;
            removeCoal.GetComponent<Button>().interactable = false;
        }
        else
        {
            addCoal.GetComponent<Button>().interactable = true;
            removeCoal.GetComponent<Button>().interactable = true;
        }

        if (valueIron < 1)
        {
            addIron.GetComponent<Button>().interactable = false;
            removeIron.GetComponent<Button>().interactable = false;
        }
        else
        {
            addIron.GetComponent<Button>().interactable = true;
            removeIron.GetComponent<Button>().interactable = true;
        }
    }
